								...
								<div class="panel-body">
									<div id="keranjang">
										<table class="table table-bordered">
											<tr>
												<td><b>Tanggal</b></td>
												<td><input type="text" readonly="readonly" class="form-control" value="<?php echo date("l, j F Y, G:i");?>" name="tgl"></td>
											</tr>
										</table>
											...
											if(!empty($_GET['nota'] == 'yes')) {
												...
												if(!empty($bayar))
												{
													...
													if($bayar >= $total)
													{
														...
														echo '<script>alert("Uang Pembayaran Kurang Rp.'.$hitung.'");</script>';
													}
												}
											}
											?>
