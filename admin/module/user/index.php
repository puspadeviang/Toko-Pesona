										...
										<div class="box-content">
											<form class="form-horizontal" method="POST" action="fungsi/edit/edit.php?profil=edit" enctype="multipart/form-data">
												<fieldset>
													...
													<div class="control-group">
														<label class="control-label" for="typeahead">Nomor Pegawai </label>
														<div class="input-group">
														  <div class="input-group-addon">
															<i class="fa fa-user"></i>
														  </div>
															<input type="text" class="form-control" style="border-radius:0px;" name="no_pegawai" value="<?php echo $hasil['no_pegawai']; ?>" required="required"/>
														</div>
													</div>
													<div class="control-group">
